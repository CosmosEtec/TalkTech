...
<div class="card">
  <div class="products">
    <div class="product active" product-id="1" product-color="#D18B49">
      ...
      <p class="description">Ás vezes, tentar aprender sozinho pode ser um pouco complicado caso não seja autodidata!</p>
    </div>
    ...
    <div class="footer">
        ...
        <a class="btn" id="next" href="#" ripple="" ripple-color="#666666">Next</a></div>
    </div>
